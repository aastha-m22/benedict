...
def create_conversation_repository(provider: str = "json", state_file: str = "state.json") -> ConversationRepository:
    ...
    """
    if provider == "json":
        from benedict.conversation_repository.conversation_repository_json import JsonConversationRepository
        return JsonConversationRepository(state_file=state_file)
    elif provider == "mock":
        from benedict.conversation_repository.conversation_repository_mock import MockConversationRepository
